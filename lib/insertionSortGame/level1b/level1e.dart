...
class Level1ePage extends StatefulWidget {
  @override
  State<Level1ePage> createState() => _Level1eState();
}

class _Level1eState extends State<Level1ePage> with TickerProviderStateMixin {
  bool swap = false;
