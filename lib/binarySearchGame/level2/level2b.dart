...
class Level2bPage extends StatefulWidget {
  Level2bPage();
  @override
  State<Level2bPage> createState() => _Level2bPageState();
}

class _Level2bPageState extends State<Level2bPage> {
  int swap1 = 0;
  int swap2 = 0;
  int swap3 = 0;
  int swap4 = 0;
                                ...
                                children: <Widget>[
                                  Center(
                                    child: RaisedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.pop(context);
                                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Level2cPage()));
                                        // Navigator.push(
                                        //     context,
